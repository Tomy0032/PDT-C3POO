...
public class EstudiantePrincipal extends JFrame {
	...
	public EstudiantePrincipal(Long idUsuario) {
		...
		lblNewLabel.setBounds(120, 102, 194, 56);
	...
	private static void setUsuario(Long idUsuario) {
		...
		EstudiantePrincipal.usuario = user;
	}
