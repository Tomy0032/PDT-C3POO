...
public class AnalistaPrincipal extends JFrame {
	...
	public AnalistaPrincipal(Long idUsuario) {
		...
		lblAnalista.setHorizontalAlignment(SwingConstants.CENTER);
		lblAnalista.setFont(new Font("Tahoma", Font.PLAIN, 37));
		lblAnalista.setBounds(120, 102, 194, 56);
		contentPane.add(lblAnalista);
	...
	private static void setUsuario(Long idUsuario) {
		...
		AnalistaPrincipal.usuario = user;
	}
